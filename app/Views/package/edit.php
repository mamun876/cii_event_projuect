    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <form action="<?= site_url('package/update/'.$id)?>" method="post">
      <div class="form-group">
        <label for="title">Title</label>
        <input type="text" class="form-control" id="title" placeholder="Enter title" name="title" required value="<?=$title?>">
      </div>

      <div class="form-group">
        <label for="subtitle">Subtitle</label>
        <input type="text" class="form-control" id="subtitle" placeholder="Enter subtitle" name="subtitle"  value="<?=$subtitle?>">
      </div>

      <div class="form-group">
        <label for="price">Price</label>
        <input type="text" class="form-control" id="price" placeholder="Enter price" name="price" required value="<?=$price?>">
      </div>

      <div class="form-group">
        <label for="service_include">Service Includes</label>
        <input class="form-control" type="text" id="service_include"  placeholder="Enter service details" name="service_include" required value="<?=$service_include?>"></input>
      </div>
